<!-- ============================ ANIMATED HEADER ============================ -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F172A,45:2563EB,100:4747EB&height=210&section=header&text=JobConnect&fontSize=60&fontColor=ffffff&fontAlignY=36&animation=fadeIn&desc=Unlock%20Your%20Dream%20Career&descAlignY=58&descSize=18" width="100%" alt="JobConnect"/>
</p>

<p align="center">
  <a href="https://job-connect-delta-woad.vercel.app/">
    <img src="https://readme-typing-svg.demolab.com/?font=Inter&weight=600&size=22&duration=2800&pause=800&color=3B82F6&center=true&vCenter=true&width=820&height=45&lines=Post+a+job.+Find+a+job.+Hire+in+minutes.;Interest-based+matching+ranks+jobs+for+you;Real-time+chat+the+moment+you+are+approved;Automated+emails+at+every+hiring+stage;Installable+PWA+-+works+like+a+native+app" alt="Typing SVG"/>
  </a>
</p>

<p align="center">
  <a href="https://job-connect-delta-woad.vercel.app/"><img src="https://img.shields.io/badge/%F0%9F%9A%80_LIVE_DEMO-job--connect--delta--woad.vercel.app-2563EB?style=for-the-badge&logoColor=white" alt="Live Demo"/></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/React_18-2563EB?style=for-the-badge&logo=react&logoColor=white" alt="React"/>
  <img src="https://img.shields.io/badge/TypeScript-1E40AF?style=for-the-badge&logo=typescript&logoColor=white" alt="TypeScript"/>
  <img src="https://img.shields.io/badge/Vite-4747EB?style=for-the-badge&logo=vite&logoColor=white" alt="Vite"/>
  <img src="https://img.shields.io/badge/Tailwind-3B82F6?style=for-the-badge&logo=tailwindcss&logoColor=white" alt="Tailwind"/>
  <img src="https://img.shields.io/badge/Firebase-F59E0B?style=for-the-badge&logo=firebase&logoColor=white" alt="Firebase"/>
  <img src="https://img.shields.io/badge/PWA-10B981?style=for-the-badge&logo=pwa&logoColor=white" alt="PWA"/>
</p>

<p align="center">
  <a href="#-the-team"><img src="https://img.shields.io/badge/%F0%9F%91%A5_Team-3_Members-2563EB?style=flat-square" alt="Team"/></a>
  <a href="#-features"><img src="https://img.shields.io/badge/%E2%9C%A8_Features-Two_Role_Platform-4747EB?style=flat-square" alt="Features"/></a>
  <a href="#-architecture"><img src="https://img.shields.io/badge/%F0%9F%8F%97%EF%B8%8F_Architecture-Serverless-1E40AF?style=flat-square" alt="Architecture"/></a>
  <a href="#-design-system"><img src="https://img.shields.io/badge/%F0%9F%8E%A8_Design-Royal_Blue_Premium-3B82F6?style=flat-square" alt="Design"/></a>
  <a href="#-getting-started"><img src="https://img.shields.io/badge/%E2%9A%A1_Setup-5_Minutes-10B981?style=flat-square" alt="Setup"/></a>
</p>

<img src="https://capsule-render.vercel.app/api?type=rect&color=0:0F172A,50:2563EB,100:4747EB&height=3" width="100%"/>
...
<p align="center">
  <a href="https://job-connect-delta-woad.vercel.app/">
    <img src="https://img.shields.io/badge/%E2%96%B6%EF%B8%8F%20Try%20it%20now%20%E2%80%94%20no%20install%20needed-2563EB?style=for-the-badge" alt="Try it"/>
  </a>
</p>
...
<td align="center" width="33%">
  <img src="https://img.shields.io/badge/%F0%9F%92%BB-Hassan_Khalid-2563EB?style=for-the-badge" alt="Hassan Khalid"/>
  <br/><br/><b>Hassan Khalid</b>
  <br/><br/><a href="https://github.com/HassanKhalid8"><img src="https://img.shields.io/badge/GitHub-HassanKhalid8-0F172A?style=flat-square&logo=github&logoColor=white" alt="GitHub"/></a>
</td>
<td align="center" width="33%">
  <img src="https://img.shields.io/badge/%F0%9F%8E%A8-Maham_Imran-4747EB?style=for-the-badge" alt="Maham Imran"/>
  <br/><br/><b>Maham Imran</b>
</td>
<td align="center" width="33%">
  <img src="https://img.shields.io/badge/%E2%9A%99%EF%B8%8F-Moiz_ud_din-3B82F6?style=for-the-badge" alt="Moiz ud din"/>
...
flowchart TB
    subgraph client["🖥️ Client — React 18 + TypeScript + Vite"]
        UI["<b>UI Layer</b><br/>shadcn/ui · Radix primitives<br/>Tailwind · Framer Motion"]
        CTX["<b>AuthContext</b><br/>onAuthStateChanged listener<br/>caches role + profile"]
        PG["<b>Pages</b><br/>Home · Auth · Dashboards<br/>Apply · Applicants · Chat"]
    end

    subgraph fb["🔥 Firebase — Backend as a Service"]
        AUTH["<b>Firebase Auth</b><br/>email + password"]
        FS["<b>Cloud Firestore</b><br/>users · jobs · applications<br/>saved_jobs · messages"]
    end

    subgraph ext["☁️ External Services"]
        CLD["<b>Cloudinary</b><br/>unsigned CV upload"]
        EJS["<b>EmailJS</b><br/>transactional email"]
    end
    ...
    PG <--> FS
    PG -- "PDF upload" --> CLD
    PG -- "status change" --> EJS
    FS -. "onSnapshot live stream" .-> PG

    classDef c fill:#0F172A,stroke:#3B82F6,stroke-width:2px,color:#DBEAFE
    classDef f fill:#1E1B4B,stroke:#4747EB,stroke-width:2px,color:#E0E7FF
    classDef e fill:#172554,stroke:#2563EB,stroke-width:2px,color:#DBEAFE
    class UI,CTX,PG c
    class AUTH,FS f
    class CLD,EJS e
```
...
```mermaid
stateDiagram-v2
    [*] --> Pending: candidate submits CV<br/>📧 recruiter notified
    Pending --> Approved: recruiter approves<br/>📧 candidate notified
    Pending --> Rejected: recruiter declines<br/>📧 candidate notified
    Approved --> Interview: date + meeting link set<br/>📧 invitation sent
    Approved --> Chat: 💬 messaging unlocked
    Interview --> Chat: 💬 messaging unlocked
    Rejected --> [*]
    Chat --> [*]

    note right of Approved
        Chat becomes available at
        Approved and stays open
        through Interview
    end note
```
...
<p align="center">
  <img src="https://img.shields.io/badge/Primary-%232563EB-2563EB?style=for-the-badge&labelColor=0F172A" alt="Primary"/>
  <img src="https://img.shields.io/badge/Gradient_End-%234747EB-4747EB?style=for-the-badge&labelColor=0F172A" alt="Gradient End"/>
  <img src="https://img.shields.io/badge/Success-%2310B981-10B981?style=for-the-badge&labelColor=0F172A" alt="Success"/>
  <img src="https://img.shields.io/badge/Warning-%23F59E0B-F59E0B?style=for-the-badge&labelColor=0F172A" alt="Warning"/>
  <img src="https://img.shields.io/badge/Destructive-%23EF4444-EF4444?style=for-the-badge&labelColor=0F172A" alt="Destructive"/>
</p>
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:4747EB,55:2563EB,100:0F172A&height=140&section=footer&text=Post%20%C2%B7%20Apply%20%C2%B7%20Approve%20%C2%B7%20Hire&fontSize=24&fontColor=ffffff&fontAlignY=72&animation=fadeIn" width="100%"/>
</p>
